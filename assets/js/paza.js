!function () {
    var eventMethod = window.addEventListener
        ...
        messageEvent = "attachEvent" == eventMethod
            ? "onmessage"
            : "message",
        config = {
    ...
    Inline.prototype.createButton = function () {
        ...
        e.defaults.customButton
            ...
            : ((t = document.createElement("button")).innerHTML = "<span class='paystack-top-blue'>Pay Securely with Paystack</span><span class='pa" +
                    "ystack-body-image'> </span>",
            t.setAttribute("class", "paystack-trigger-btn"), t.setAttribute("data-paystack", e.defaults.id), sourceScript.parentNode.insertBefore(t, sourceScript.nextSibling)),
    ...
    Inline.prototype.getTransactionParameters = function () {
        ...
        t.split && "string" != typeof t.split && 0 < Object
            .keys(t.split)
            .length && (t.split = JSON.stringify(t.split)),
        void 0 !== t.card && -1 < [
            "false", !1
        ].indexOf(t.card) && (t.channels = ["bank"], delete t.card),
        void 0 !== t.bank && -1 < [
            "false", !1
        ].indexOf(t.bank) && (t.channels = ["card"], delete t.bank),
        t
    },
        ...
        eventer(messageEvent, function (t) {
            ...
            if (e && ("string" == typeof e || e instanceof String)) {
                ...
                if (!n.isThisIframe || "PaystackResize" != n.action) 
                    return;
                document
                    .getElementById(r.defaults.container)
                    .style
                    .height = Math.max(Number(n.data), 250) + "px"
            }
        }, !1)
    },
    ...
    Inline.prototype.setupNewPopup = function () {
        ...
        t.style.cssText = "z-index: 999999999999999;background: transparent;background: rgba(0, 0, 0, 0.75)" +
                ";border: 0px none transparent;overflow-x: hidden;overflow-y: hidden;margin: 0;pa" +
                "dding: 0;-webkit-tap-highlight-color: transparent;-webkit-touch-callout: none;po" +
                "sition: fixed;left: 0;top: 0;width: 100%;height: 100%;transition: opacity 0.3s;-" +
                "webkit-transition: opacity 0.3s;visibility: hidden;",
        t.style.display = "none",
        this.background = t,
        document
            .body
        ...
        e.open(),
        e.write('<!DOCTYPE html> <html lang="en"> <head> <meta charset="UTF-8"> <meta name="viewp' +
                'ort" content="width=device-width, initial-scale=1.0"> <meta http-equiv="X-UA-Com' +
                'patible" content="ie=edge"> <title>Paystack Checkout Loader</title> <style> .app' +
                '-loader { margin: 200px 0; text-align: center; color: white; } @keyframes app-lo' +
                'ader__spinner { 0% { opacity: 1; } 100% { opacity: 0; } } @-webkit-keyframes app' +
                '-loader__spinner { 0% { opacity: 1; } 100% { opacity: 0; } } .app-loader__spinne' +
                'r { position: relative; display: inline-block; } .app-loader__spinner div { left' +
                ': 95px; top: 35px; position: absolute; -webkit-animation: app-loader__spinner li' +
                'near 1s infinite; animation: app-loader__spinner linear 1s infinite; background:' +
                ' white; width: 10px; height: 30px; border-radius: 40%; -webkit-transform-origin:' +
                ' 5px 65px; transform-origin: 5px 65px; } .app-loader__spinner div:nth-child(1) {' +
                ' -webkit-transform: rotate(0deg); transform: rotate(0deg); -webkit-animation-del' +
                'ay: -0.916666666666667s; animation-delay: -0.916666666666667s; } .app-loader__sp' +
                'inner div:nth-child(2) { -webkit-transform: rotate(30deg); transform: rotate(30d' +
                'eg); -webkit-animation-delay: -0.833333333333333s; animation-delay: -0.833333333' +
                '333333s; } .app-loader__spinner div:nth-child(3) { -webkit-transform: rotate(60d' +
                'eg); transform: rotate(60deg); -webkit-animation-delay: -0.75s; animation-delay:' +
                ' -0.75s; } .app-loader__spinner div:nth-child(4) { -webkit-transform: rotate(90d' +
                'eg); transform: rotate(90deg); -webkit-animation-delay: -0.666666666666667s; ani' +
                'mation-delay: -0.666666666666667s; } .app-loader__spinner div:nth-child(5) { -we' +
                'bkit-transform: rotate(120deg); transform: rotate(120deg); -webkit-animation-del' +
                'ay: -0.583333333333333s; animation-delay: -0.583333333333333s; } .app-loader__sp' +
                'inner div:nth-child(6) { -webkit-transform: rotate(150deg); transform: rotate(15' +
                '0deg); -webkit-animation-delay: -0.5s; animation-delay: -0.5s; } .app-loader__sp' +
                'inner div:nth-child(7) { -webkit-transform: rotate(180deg); transform: rotate(18' +
                '0deg); -webkit-animation-delay: -0.416666666666667s; animation-delay: -0.4166666' +
                '66666667s; } .app-loader__spinner div:nth-child(8) { -webkit-transform: rotate(2' +
                '10deg); transform: rotate(210deg); -webkit-animation-delay: -0.333333333333333s;' +
                ' animation-delay: -0.333333333333333s; } .app-loader__spinner div:nth-child(9) {' +
                ' -webkit-transform: rotate(240deg); transform: rotate(240deg); -webkit-animation' +
                '-delay: -0.25s; animation-delay: -0.25s; } .app-loader__spinner div:nth-child(10' +
                ') { -webkit-transform: rotate(270deg); transform: rotate(270deg); -webkit-animat' +
                'ion-delay: -0.166666666666667s; animation-delay: -0.166666666666667s; } .app-loa' +
                'der__spinner div:nth-child(11) { -webkit-transform: rotate(300deg); transform: r' +
                'otate(300deg); -webkit-animation-delay: -0.083333333333333s; animation-delay: -0' +
                '.083333333333333s; } .app-loader__spinner div:nth-child(12) { -webkit-transform:' +
                ' rotate(330deg); transform: rotate(330deg); -webkit-animation-delay: 0s; animati' +
                'on-delay: 0s; } .app-loader__spinner { width: 40px; height: 40px; -webkit-transf' +
                'orm: translate(-20px, -20px) scale(0.2) translate(20px, 20px); transform: transl' +
                'ate(-20px, -20px) scale(0.2) translate(20px, 20px); } </style> </head> <body> <d' +
                'iv id="app-loader" class="app-loader"> <div id="spinner" class="app-loader__spin' +
                'ner"> <div></div><div></div><div></div><div></div><div></div><div></div><div> </' +
        ...
        n.style.cssText = "z-index: 999999999999999;background: transparent;border: 0px none transparent;ov" +
                "erflow-x: hidden;overflow-y: hidden;margin: 0;padding: 0;-webkit-tap-highlight-c" +
                "olor: transparent;-webkit-touch-callout: none;position: fixed;left: 0;top: 0;wid" +
                "th: 100%;height: 100%;visibility:hidden;",
    ...
    Inline.prototype.handleSuccess = function (t) {
        ...
        if (this.defaults.callback || this.form) 
            return this.form
                ? ((e = document.createElement("input")).type = "hidden", e.value = t.reference, e.name = "reference", this.form.appendChild(e), (e = document.createElement("input")).type = "hidden", e.value = t.reference, e.name = "paystack-trxref", this.form.appendChild(e), void this.form.submit())
                : void(this.defaults.callback && this.defaults.callback.call(this, t))
        },
    Inline.prototype.callCloseCallback = function () {
        this.defaults.onClose && this
            .defaults
            .onClose
            .call(this)
    };
    ...
    function isObject(t) {
        return t === Object(t) && "[object Array]" !== Object
            .prototype
            .toString
            .call(t)
    }
    ...
    function cssLoad(t, e) {
        ...
        void 0 !== u.addEventListener
            ...
            : void 0 !== u.attachEvent && u.attachEvent("onload", function () {
                var t,
...
function (t) {
    ...
    function g() {
        ...
        this._initBody = function (t) {
            ...
            this
                .headers
                .get("content-type") || ("string" == typeof t
    ...
    function w(t, e) {
        ...
        if (t instanceof w) {
            ...
            this.url = String(t);
        if (this.credentials = e.credentials || this.credentials || "omit", !e.headers && this.headers || (this.headers = new f(e.headers)), this.method = (r = (n = e.method || this.method || "GET").toUpperCase(), -1 < d.indexOf(r)
            ? r
            : n), this.mode = e.mode || this.mode || null, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && i) 
    ...
    function _(t, e) {
        e || (e = {}),
        this.type = "default",
        this.status = void 0 === e.status
            ? 200
            : e.status,
        this.ok = 200 <= this.status && this.status < 300,
        this.statusText = "statusText" in e
            ? e.statusText
            : "OK",
...
function (t, e) {
    ...
    function i(n, r) {
        ...
        0 !== n._state
            ? (n._handled = !0, a._immediateFn(function () {
                var t = 1 === n._state
                    ? r.onFulfilled
                    : r.onRejected;
                if (null !== t) {
                ...
                try {
                    ...
                    if (t && ("object" == typeof t || "function" == typeof t)) {
                        ...
                        if ("function" == typeof n) 
                            return void d((r = n, i = t, function () {
                                r.apply(i, arguments)
                            }), e)
                    }
                    e._state = 1,
